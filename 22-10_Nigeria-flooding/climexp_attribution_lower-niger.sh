...
info1=`echo "distribution fit_type confint include_event return_period obs_start event_year restrain gmst_past gmst_fut"`
info2=`echo "${distribution} ${fit_type} ${confint} ${include_event} ${return_period} ${obs_start} ${event_year} ${restrain} ${gmst_past} ${gmst_fut}"`
...
eval_headers="disp_est disp_lower disp_upper xi_est xi_lower xi_upper alpha_est alpha_lower alpha_upper"
eval_params=`echo ${dispersion} ${xi} ${alpha}`
